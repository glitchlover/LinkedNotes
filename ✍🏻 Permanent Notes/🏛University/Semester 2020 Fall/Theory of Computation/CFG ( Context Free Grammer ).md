...
2.  Based on number of derivatio   -   If there is only 1 derivation tree then the CFG is unambiguous.
...
Def::A derivation of aammar is a sequence of grammar rule applications that transform the start symbol into the string.<iframe src="https://www.youtube.com/embed/u4-rpIlV9NI" class="resize-vertical" style="height: 543px;"></iframe>
^1608306158734
...
-   **Bottom-up Approach −**  #card
    -   Starts from tree leaeeds upward to the root which is the starti^1608393334214
ng symbol **S**
...
^artial derivation tree is a sub-tree of a derivation tree/parse tree such that either all of its children are in the sub-tree or none of them are in the sub-tree. Also it is a string
^1608392446619
